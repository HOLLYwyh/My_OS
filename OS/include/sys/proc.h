...
#define STACK_SIZE_PS_MONITOR	STACK_SIZE_DEFAULT
#define STACK_SIZE_FS_MONITOR	STACK_SIZE_DEFAULT
#define STACK_SIZE_MM_MONITOR	STACK_SIZE_DEFAULT
...
#define STACK_SIZE_TOTAL	(STACK_SIZE_TTY + \
				...
				STACK_SIZE_MM + \
				STACK_SIZE_INIT + \
				STACK_SIZE_PS_MONITOR + \
				STACK_SIZE_FS_MONITOR + \
				STACK_SIZE_MM_MONITOR)
